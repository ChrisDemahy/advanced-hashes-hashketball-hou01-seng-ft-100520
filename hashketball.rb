...
def player_numbers(team)
  game_hash[:away][:players].map { |e| e[:number] } if game_hash[:away][:team_name] == team 
  game_hash[:home][:players].map { |e| e[:number] } if game_hash[:home][:team_name] == team 
end
